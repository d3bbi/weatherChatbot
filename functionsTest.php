...
class functionsTest extends PHPUnit\Framework\TestCase
{
    ...
    {
        require "functions/functionProcessDate.php";
        $expected = array("date", "It would be great to travel back in time! Please enter a future date.", "12-02-1995");
    ...
    {
        require "functions/functionProcessDate.php";
        $expected = array("date", "I'm sorry I didn't get that date. Can you try again?", "2021-25-12");
    ...
    public function testProcessCountryNegativeReturn(): void
        ...
        public function testProcessCityNegativeReturn(): void
        {
           require "functions/functionProcessCity.php";
            $expected = array("city", "Couldn't Find", "Ireland","Dublin");
